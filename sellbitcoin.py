...
def buy_crypto_currency(ticker, krw):
    ...
    bithumb.buy_market_order(ticker, unit*0.01)
...
# print(get_yesterday_ma5(ticker))
...
print(krw_first + krw_second + krw_third + krw_forth)
print(krw)
...
#             buy_price_3 = 1
#             buy_price_4 = 1          
#             post_message(myToken,"#engineer", "New ticker : " + ticker + "Target Price : " + str(target_price))
